                ...
                <div className="flex gap-16 max-w-[1500px] flex-wrap justify-center">
                    {albums.map((album) => (
                        <AlbumPop key={album.id}>
                            <Link  href={`/albums/${album.id}`} className="border-2 bg-indigo-100 p-4 flex flex-col mt-3 items-center rounded-xl border-zinc-400 max-w-[350px] shadow-lg rounded-lg shadow-blue-500/50 ">
